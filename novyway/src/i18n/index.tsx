...
const dict = {
  ...
  'sc.title': { ru: 'Индекс участия', en: 'Participation index' },
  'sc.hint': { ru: 'Единое значение из профиля участника', en: 'The single value from the participant profile' },
  ...
  'sc.readChip': { ru: 'прочитан', en: 'read' },
  'sc.votes': { ru: 'голосов', en: 'votes' },
  'sc.docs': { ru: 'документов', en: 'documents' },
  'sc.exams': { ru: 'экзаменов', en: 'exams' },
  'sc.local': { ru: 'Индекс берётся из профиля участника.', en: 'The index comes from the participant profile.' },
